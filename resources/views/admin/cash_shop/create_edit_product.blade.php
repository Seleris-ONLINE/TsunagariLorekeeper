...
<div class="form-group">
    ...
    {!! Form::number('price', $product->price ?? null, ['class' => 'form-control stock-field', 'data-name' => 'price', 'min' => 1, 'placeholder' => 'Example: 5 or 5.00']) !!}
</div>
...
{{-- hidden form --}}
<div class="row stock-check hide">
    <div class="col-md">
        <div class="form-group">
            {!! Form::label('quantity', 'Quantity', ['class' => 'form-check-label mb-2']) !!}
            {!! Form::number('quantity', $product->quantity ?? null, ['class' => 'form-control', 'data-name' => 'quantity', 'min' => 0, 'placeholder' => 'Stock Quantity']) !!}
        </div>
    </div>
    <div class="col-md">
        <div class="form-group">
...
@include('widgets._product_select', ($product->id ? ['loots' => 
     (object)[
