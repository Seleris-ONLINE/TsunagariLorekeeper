...
return [
    ...
    */
    ...
    'character_theme' => [
        ...
        'is_unique' => 1, // Are these themes unique across characters? (Only one character can have "black cat" for example). Players can always skirt around this by changing wording slightly, so remember to check definitively in design updates. 0 for No, 1 for Yes.
