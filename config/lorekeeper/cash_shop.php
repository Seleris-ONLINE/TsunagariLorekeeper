...
return [
    ...
    // title that appears on top of page
    'shop_title' => 'Cash Shop',
    // description that appears on top of page
    'shop_description' => 
        'Welcome to the Cash Shop! Here you can purchase items in-real-life currency.
        <br /> 
        Please note that all purchases are final and cannot be refunded.',
