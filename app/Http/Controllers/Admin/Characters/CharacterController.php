    ...
    */
    ...
    public function postCreateCharacter(Request $request, CharacterManager $service) {
        ...
        $data = $request->only([
            ...
            'image', 'thumbnail', 'image_description', 'label', 'label_information', 'theme', 'transformation_id', 'transformation_info', 'transformation_description'
        ]);
    ...
    public function postCreateMyo(Request $request, CharacterManager $service) {
        ...
        $data = $request->only([
            ...
            'artist_id', 'artist_url',
            'species_id', 'subtype_id', 'rarity_id', 'feature_id', 'feature_data',
            'image', 'thumbnail', 'theme', 'transformation_id', 'transformation_info', 'transformation_description'
        ]);
