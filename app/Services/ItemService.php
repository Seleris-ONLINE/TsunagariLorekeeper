    ...
    **********************************************************************************************/
    ...
    public function deleteItem($item, $user) {
        ...
        try {
            ...
            if (DB::table('shop_products')->where('item_id', $item->id)->exists()) {
                throw new \Exception('Cash shop currently stocks this item. Please remove the item before deleting it.');
            }
